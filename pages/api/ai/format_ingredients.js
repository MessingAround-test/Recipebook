...
- 'name': ONLY the core ingredient (e.g. "chopped garlic" -> "garlic", "boneless chicken breast fillets" -> "chicken breast"). No quantities, units, or prep words.
...
- 'note': The prep work and other details about the ingredient (e.g. "chopped", "finely diced", "at room temperature", "plus extra for frying"). Empty string if none.
