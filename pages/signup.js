        ...
        <div className={styles.container}>
            ...
            <main className={styles.main_flex} >
                <Card style={{ width: '40vh' }}>
                    ...
                    <Card.Body>
                        <Card.Title>Sign Up- this page doesnt work RN</Card.Title>

                        <Form onSubmit={(e)=>onSubmit(e)}>
                        <Form.Group className="mb-3" id="formBasicEmail">
                                <Form.Label>Username</Form.Label>
                                <Form.Control name="username" id="username" type="text" placeholder="Enter username" onChange={(e)=>setUsername(e.target.value)}/>
