...
export const quantity_type_conversions = {
    "each": { "synonyms": ["each", "eachs", "x"], "type": "count", "ratio": 1, "ratio_base": "each" },
    ...
    "pinch": { "synonyms": ["pinch", "pinches"], "type": "count", "ratio": 1, "ratio_base": "each" },
    "dash": { "synonyms": ["dash", "dashes"], "type": "count", "ratio": 1, "ratio_base": "each" },
    "handful": { "synonyms": ["handful", "handfuls"], "type": "count", "ratio": 1, "ratio_base": "each" },
    "sprinkle": { "synonyms": ["sprinkle", "sprinkles"], "type": "count", "ratio": 1, "ratio_base": "each" },
    "slice": { "synonyms": ["slice", "slices"], "type": "count", "ratio": 1, "ratio_base": "each" },
    "piece": { "synonyms": ["piece", "pieces"], "type": "count", "ratio": 1, "ratio_base": "each" },
    "clove": { "synonyms": ["clove", "cloves"], "type": "count", "ratio": 1, "ratio_base": "each" },
    "can": { "synonyms": ["can", "cans"], "type": "count", "ratio": 1, "ratio_base": "each" },
    "bottle": { "synonyms": ["bottle", "bottles"], "type": "count", "ratio": 1, "ratio_base": "each" },
    "package": { "synonyms": ["package", "packages"], "type": "count", "ratio": 1, "ratio_base": "each" },
    "stick": { "synonyms": ["stick", "sticks"], "type": "count", "ratio": 1, "ratio_base": "each" }
}
...
export function convertMetricReading(inputText) {
    ...
    for (const index in wordsFound) {
        ...
        let keyFound = findKeyFromInput(wordsFound[index].toLowerCase(), quantity_type_conversions, "synonyms");
        if (keyFound) {
            return { "quantity": numberFound, "quantity_unit": keyFound, "quantity_type": quantity_type_conversions[keyFound].type }
        }
    }

    return { "quantity": numberFound, "quantity_type": "each", "quantity_unit": "count"}
}
