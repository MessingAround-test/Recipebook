...
/**
 * Rounds a scaled quantity to a sensible display value:
 * fractional parts snap to nearest quarter, larger values round to nearest integer or 0.5.
 */
export function formatScaledQuantity(qty) {
    ...
    const rounded = Math.round(quarters * 100) / 100;
    return rounded === 0 && num > 0 ? 0.25 : rounded;
}
