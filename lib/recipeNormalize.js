...
// Words that describe a physical preparation ACTION, not the ingredient
// itself. Stripping these into the Note keeps "mashed avocado" and "avocado"
// as the same base ingredient so nutrition lookups don't duplicate.
// Deliberately conservative: words that often appear inside product names
// ("smoked paprika", "ground beef", "white wine vinegar", "extra virgin
// olive oil", "frozen peas") are NOT listed — when in doubt, leave the word
// in the name. The AI formatter endpoint handles the nuanced cases.
const PREP_WORDS = new Set([
    'mashed', 'smashed', 'chopped', 'diced', 'cubed', 'sliced', 'grated',
    'shredded', 'minced', 'crushed', 'pounded', 'pressed',
    'peeled', 'skinned', 'pitted', 'seeded', 'deseeded',
    'trimmed', 'halved', 'quartered', 'thawed',
    'drained', 'rinsed', 'soaked',
    'melted', 'softened', 'whipped', 'whisked', 'beaten', 'blended',
    'pureed', 'puréed', 'broken', 'crumbled', 'torn', 'squeezed', 'zested'
]);
